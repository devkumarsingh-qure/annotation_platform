                  ...
                  {study.series.length === 0 ? (
                    ...
                    <ul className="space-y-1">
                      {study.series.map((studySeries) => {
                        const active =
                          String(seriesId) === String(studySeries.id);
                        const n = studySeries.total_instances;
                        return (
                          <li key={studySeries.id}>
                            <button
                              ...
                              className={`w-full min-w-0 rounded-md border px-2 py-1.5 text-left transition focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-[var(--accent)] ${
                                active
                            ...
                            >
                              ...
                              <p
                                ...
                                title={
                                  studySeries.SeriesDescription || undefined
                                }
                              >
