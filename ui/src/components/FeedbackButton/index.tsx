...
function FeedbackButton() {
  return (
    <button
      ...
      className="fixed right-0 top-1/2 z-30 inline-flex -translate-y-1/2 items-center gap-1.5 rounded-l-full border border-r-0 border-[color-mix(in_srgb,var(--accent-strong)_42%,transparent)] bg-gradient-to-br from-[var(--accent)] to-[var(--accent-strong)] px-2.5 py-2 text-xs font-semibold text-white shadow-[0_14px_30px_-18px_color-mix(in_srgb,var(--accent-strong)_85%,transparent)] transition hover:brightness-[1.05] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--accent)]"
    >
