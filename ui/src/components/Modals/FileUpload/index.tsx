...
function FileUpload({
  ...
  onBatchUploadComplete: (
    batchStatuses: Record<string, { success: boolean; patient: PatientDetail }>,
  ) => void;
}) {
                      ...
                      <div className="flex shrink-0 items-center justify-end gap-4 text-right">
                        ...
                        <div>
                          <p className="text-sm text-[var(--muted)]">
                            ...
                            {" succeeded"}
                            <span className="mx-1.5 text-[var(--border)]">
                              ·
                            </span>
                          ...
                          className={classNames(
                            "flex items-center justify-between gap-3 px-3 py-2.5 first:pt-2.5 last:pb-2.5",
                            {
                              ...
                              "bg-[color:var(--success)]/20":
                                uploadFileStatuses[file.name]?.success === true,
              ...
              <footer className="shrink-0 border-t border-[var(--border)] px-4 py-3">
                <div className="flex flex-wrap items-center justify-end gap-2">
                  <button
                    type="button"
                    className={classNames(
                      "cursor-pointer inline-flex items-center justify-center rounded-md border border-[var(--border)] bg-[var(--surface-soft)] px-4 py-2 text-sm font-medium text-[var(--text)] transition hover:brightness-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)]",
                      {
                        "opacity-50 pointer-events-none": isUploading,
                      },
                    )}
                  ...
                  <button
                    type="button"
                    className={classNames(
                      "cursor-pointer inline-flex items-center justify-center gap-2 rounded-md border border-[var(--accent)]/40 bg-gradient-to-br from-[var(--accent)] to-[var(--accent-strong)] px-4 py-2 text-sm font-medium text-white shadow-sm transition hover:brightness-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-transparent",
                      {
                        "opacity-50 pointer-events-none": isUploading,
                      },
                    )}
